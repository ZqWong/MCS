...
namespace MCS
{
    public partial class 选择考生所属公司界面 : Form
    {
        /// <summary>
        /// 总记录数
        /// </summary>
        ...
        private void BindDataWithPage(int index, int pageSize)
        {
            ...
            if (ds != null)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    this.dgvExamineeCompanyInfo.Rows[i].Cells["btnUpdate"].Value = "选择";
        ...
        private void dgvExamineeCompanyInfo_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (column is DataGridViewButtonColumn)
                {
                    ...
                    考生信息添加界面 parentForm = (考生信息添加界面)this.Owner;

                    parentForm.ChildFormClose(ecm);
        ...
        private void txtExamineeCompanyName_TextChanged(object sender, System.EventArgs e)
        {
            //if ()
            //{
