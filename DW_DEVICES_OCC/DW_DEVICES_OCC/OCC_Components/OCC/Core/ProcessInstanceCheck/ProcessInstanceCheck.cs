...
namespace OCC.Core
{
    ...
    /// 检测是否有相同实例也在运行
    /// </summary>
    public static class ProcessInstanceCheck
    {
        /// <summary>
        /// 是否退出应用程序
        /// </summary>
        ...
        public static void InstanceCheck(Action runForm)
        {
            // 只运行一个实例
        ...
        {
            Debug.Error("CurrentDomain_UnhandledException");
            Debug.Error("IsTerminating : " + e.IsTerminating.ToString());
            Debug.Error(e.ExceptionObject.ToString());
        ...
        {
           Debug.Error("Application_ThreadException:" + e.Exception.Message);
