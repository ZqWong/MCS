...
namespace EventGroup.RabbitMQ
{
    public class RabbitMQManager : LockedSingletonClass<RabbitMQManager>, IEventBase
    {
        ...
        public void Initialize(string borkerName, string localIp, string processName, string exchangeType, string userName, string hostName, string passWord, string ssl = "0", string sync = "0", int timeout = 0)
        {
        ...
        public void CreateConsumerChannel()
        {
            ...
            while (_connection == null)
            {
                ...
                {
                    Debug.Error($"CreateConsumerChannel {e}");
