    ...
    public class Client : IClient
    {
        ...
        public ConnectResult Connect()
        {
            if (this.options.TcpPort > 0 && this.tcpSocket == null)
            {
                ...
                if (this.options.IsSyncPattern == false)
                {
        ...
        public void ReceiveSyncTcp()
        {
            ...
            if (this.isRunning)
            {
                if (this.tcpSocket.Poll(-1, SelectMode.SelectWrite))
                {
        ...
        public IPacketSerialiser GetPacketSerialiser()
        {
